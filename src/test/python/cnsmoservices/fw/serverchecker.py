...
class FirewallServerAppTest(unittest.TestCase):
    ...
    bad_rule3 = '{"direction":"in", "protocol":"tcp", "dst_port":"8080", "ip_range":"127.0.0.1/33", "action":"drop"}'
    bad_rule4 = '{"direction":"in", "protocol":"tcp", "dst_port":"8080", "ip_range":"127.0.0.1.1/32", "action":"drop"}'
    bad_rule5 = '{"direction":"in", "protocol":"tcp", "dst_port":"8080", "ip_range":"127.0.0.0", "action":"drop"}'
    bad_rule6 = '{"direction":"in", "protocol":"tcp", "dst_port":"8080", "ip_range":"127.0.0.1/32", "action":"bad_action"}'
    bad_rule7 = '{"direction":"in", "protocol":"tcp", "dst_port":"bad_port", "ip_range":"127.0.0.1/32", "action":"drop"}'

    good_rules = {rule1, rule2, rule3}
    bad_rules = {bad_rule1, bad_rule2, bad_rule3, bad_rule4, bad_rule5, bad_rule6, bad_rule7}
