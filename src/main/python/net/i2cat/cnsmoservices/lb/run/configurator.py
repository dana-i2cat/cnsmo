...
def get_app_request(host, port, service_id, lb_address, lb_port, lb_mode, lb_backend_servers):
    ...
    d = dict(service_id=service_id,
             ...
             resources = ["https://raw.githubusercontent.com/dana-i2cat/cnsmo/feature/pre-build-lb-docker/src/main/python/net/i2cat/cnsmoservices/lb/app/configurator.py",
                          "https://raw.githubusercontent.com/dana-i2cat/cnsmo-net-services/feature/pre-build-lb-docker/src/main/docker/lb/start.bash",
                          ],
             dependencies=[],
