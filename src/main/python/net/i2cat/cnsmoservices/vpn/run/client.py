...
def get_app_request(host, port, service_id):
    ...
    d = dict(service_id=service_id,
             ...
             resources=["https://raw.githubusercontent.com/dana-i2cat/cnsmo/feature/sdn/src/main/python/net/i2cat/cnsmoservices/vpn/app/client.py",
                        "https://raw.githubusercontent.com/dana-i2cat/cnsmo-net-services/feature/sdn/src/main/docker/vpn/client/Dockerfile",
                        "https://raw.githubusercontent.com/dana-i2cat/cnsmo-net-services/feature/sdn/src/main/docker/vpn/client/tun_manager.sh",
                        ],
