...
def get_app_request(host, port, service_id, vpn_server_address, vpn_server_port, vpn_address):
    ...
    d = dict(service_id=service_id,
             ...
             resources = ["https://raw.githubusercontent.com/dana-i2cat/cnsmo/SDNdevelop/src/main/python/net/i2cat/cnsmoservices/vpn/app/configurator.py",
                          "https://raw.githubusercontent.com/dana-i2cat/cnsmo-net-services/SDNdevelop/src/main/docker/vpn/easy-rsa/gen_ca.sh",
                          "https://raw.githubusercontent.com/dana-i2cat/cnsmo-net-services/SDNdevelop/src/main/docker/vpn/easy-rsa/gen_client.sh",
                          "https://raw.githubusercontent.com/dana-i2cat/cnsmo-net-services/SDNdevelop/src/main/docker/vpn/easy-rsa/gen_index.sh",
                          "https://raw.githubusercontent.com/dana-i2cat/cnsmo-net-services/SDNdevelop/src/main/docker/vpn/easy-rsa/gen_server.sh",
                          "https://raw.githubusercontent.com/dana-i2cat/cnsmo-net-services/SDNdevelop/src/main/docker/vpn/easy-rsa/build-ca",
                          "https://raw.githubusercontent.com/dana-i2cat/cnsmo-net-services/SDNdevelop/src/main/docker/vpn/easy-rsa/build-key",
                          "https://raw.githubusercontent.com/dana-i2cat/cnsmo-net-services/SDNdevelop/src/main/docker/vpn/easy-rsa/build-key-server",
                          "https://raw.githubusercontent.com/dana-i2cat/cnsmo-net-services/SDNdevelop/src/main/docker/vpn/easy-rsa/vars",
                          ],
             dependencies=[],
