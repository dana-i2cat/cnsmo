...
def get_server_app_request(host, port, service_id):
    ...
    d = dict(service_id=service_id,
             ...
             resources=["https://raw.githubusercontent.com/dana-i2cat/cnsmo/feature/sdn/src/main/python/net/i2cat/cnsmoservices/vpn/app/server.py",
                        "https://raw.githubusercontent.com/dana-i2cat/cnsmo-net-services/feature/sdn/src/main/docker/vpn/server/Dockerfile",
                        "https://raw.githubusercontent.com/dana-i2cat/cnsmo-net-services/feature/sdn/src/main/docker/vpn/server/tun_manager.sh",],
             dependencies=[],
